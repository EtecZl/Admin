            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small">Perfil Administrativo da CompletLar</p>

                  <h5 class="card-title">Detalhes da Filial</h5>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">São Paulo, SP, 08080808</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Telefone</div>
                    <div class="col-lg-9 col-md-8">(11) 98765-4321</div>
                  </div>
                </div>
